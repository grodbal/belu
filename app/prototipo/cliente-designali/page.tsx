import ClienteDesignaliPage from "@/components/cliente-designali/ClienteDesignaliPage";
...
export default async function ClienteDesignaliPrototypePage() {
