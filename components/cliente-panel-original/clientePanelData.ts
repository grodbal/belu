import type { Addon, Beluer, HistorialItem, PagoItem, Service } from "./clientePanelTypes";
...
export const beluersData: Beluer[] = [
  {
...
export const historialData: HistorialItem[] = [
  {
    id: 1,
...
export const pagosData: PagoItem[] = [
  {
    id: "BLU-2026-00031",
    fecha: "2026-04-24",
